    ...
    return (
      <div className={modalClasses}>
        ...
        <div className="admin-modal-content">
          <button className="admin-modal__close" onClick={this.toggleModal}>
          ...
          <div className="admin-modal-form form">
            {this.props.fields.map((field, idx) => (
              <label className="form-label" data-field={field.name} key={field.name}>
                {field.label}
                {field.type !== "select" ? (
                  <input
                ...
                {this.state.errors[idx] ? (
                  <span className="form-label__error">{this.state.errors[idx]}</span>
                ) : (
                  ""
                )}
              </label>
