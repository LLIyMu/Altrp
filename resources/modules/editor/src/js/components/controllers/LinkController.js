...
class LinkController extends Component {
  ...
  toggleSettingsNewPage() {
    let toggleSettingsNewPageCheckbox = document.getElementById(
      "toggleSettingsNewPageCheckbox"
    );
  ...
  toggleSettingsNoFollow() {
    let togglesettingsNoFollowCheckbox = document.getElementById(
      "togglesettingsNoFollowCheckbox"
    );
  ...
  render() {
    return (
      <div className="controller-container controller-container_link">
        ...
        <div className="control-link-input-wrapper">
          ...
          ></input>
          <div
            className="control-link-settings control-link-button"
        ...
        <div id="settings" className="settingBlock settingBlock-none">
          <div
            className="settings-checkbox-option"
            onClick={this.toggleSettingsNewPage}
          >
            <input
              id="toggleSettingsNewPageCheckbox"
              type="checkbox"
          ...
          <div
            className="settings-checkbox-option"
            onClick={this.toggleSettingsNoFollow}
          >
            <input
              id="togglesettingsNoFollowCheckbox"
              type="checkbox"
              className="settings-checkbox"
            />
            <span className="settings-checkbox-container" />
          ...
          <div className="customAttributes">
            <div className="control-link-header">
              <label className="controller-container__label">
            ...
            />
            <a className="settings-attribute-description">
              Задайте пользовательские атрибуты для ссылки. Отделяйте ключи атрибута
              от значений с помощью символа | (труба). Разделите пары ключ-значение
              запятой.
            </a>
          </div>
        </div>
