...
class CssEditorController extends Component {
  ...
  render() {
    ...
    return (
      <div className="controller-container controller-container_css-editor">
        ...
        <div className="control-css-editor-description">
          ...
          <br />
          Examples: selector "color: red;" // For main element selector
          .child-element "margin: 10px;" // For <br />
          child element
          <br />
