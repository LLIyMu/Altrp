...
class ButtonController extends Component {
  ...
  render() {
    return (
      <div className="controller-container controller-container_button">
          ...
          {this.props.buttons.map((buttons) => {
            return (
              <button
                ...
                id={"activeButton" + buttons.key}
                data-key={buttons.key}
                onClick={this.changeValue}
                className={
                  this.state.value.button === buttons.value
                    ? this.state.value.activeClass
                    : ""
                }
