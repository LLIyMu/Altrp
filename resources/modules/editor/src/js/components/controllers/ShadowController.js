    ...
    return (
      <div className="controller-container controller-container_shadow">
        ...
        <div className="control-group control-group-shadow">
          ...
          <div
            id="shadowContainer"
            className="control-shadow-wrapper control-shadow-wrapper-none"
          >
            {/* начало color */}
            ...
            {this.state.active ? (
              <div id="colorPicker" className="control-color-colorPicker">
                <SketchPicker
                  ...
                  color={this.state.value.colorRGB}
            ...
            <div className="control-slider-header">
              <div className="control-slider-label">horizontal displacement</div>
            </div>
            <div className="control-slider-input-wrapper">
              <input
                ...
                className="control-slider"
                value={this.state.value.horizontal}
            ...
            <div className="control-slider-header">
              <div className="control-slider-label">vertical displacement</div>
            </div>
            <div className="control-slider-input-wrapper">
              <input
                type="range"
                ...
                max={this.state.horVerMax}
                className="control-slider"
                value={this.state.value.vertical}
