...
class SettingsPanel extends Component {
  ...
  render() {
    ...
    let contentTabClasses =
      "panel-tab d-flex " + (this.state.activeTab === TAB_CONTENT ? "active" : "");
    let styleTabClasses =
      "panel-tab d-flex " + (this.state.activeTab === TAB_STYLE ? "active" : "");
    let advancedTabClasses =
      "panel-tab d-flex " + (this.state.activeTab === TAB_ADVANCED ? "active" : "");
    return (
