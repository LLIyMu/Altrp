              ...
              (r.prototype = {
                ...
                matchWhile: function (e) {
                  ...
                  var t = new RegExp("^" + e + "+"),
                    n = t.exec(this.slice());
                  if (n) {
                    if (!this.eof && n[0].length == this.data.length - this.start)
                      throw r.DRAIN;
                  ...
                  return (
                    i === r.EOF
                      ...
                      ? (t._parseError("invalid-codepoint"),
                        (t._currentToken.data += "-\ufffd"),
                        t.setState(tt))
                      : ((t._currentToken.data += "-" + i + e.matchUntil("\0|-")),
                        e.char()),
                    !0
                  );
                }
          ...
          function (e, t, n) {
            ...
            function g() {
              ...
              (t.base = {
                  ...
                  e.insertDoctype(t || "", n || "", r || ""),
                    ...
                    (r != null &&
                      ...
                      : (n == "-//W3C//DTD HTML 4.0//EN" &&
                          (r == null ||
                            r == "http://www.w3.org/TR/REC-html40/strict.dtd")) ||
                ...
                (t.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle = function (
                  e,
                  n
                ) {
                  t.inHead.processStartTag(e, n);
                ...
                (t.text.startTagOther = function (e) {
                  throw (
                    "Tried to process start tag " + e + " in RCDATA/RAWTEXT mode"
                  );
                }),
            ...
            (m.prototype.skipAtMostOneLeadingNewline = function () {
              ...
              (g.prototype.isCdataSectionAllowed = function () {
                return (
                  this.openElements.length > 0 && this.currentStackItem().isForeign()
                );
              }),
