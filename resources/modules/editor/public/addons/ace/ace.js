    ...
    (t.isWin = i == "win"),
      ...
      (t.isIE =
        o == "Microsoft Internet Explorer" || o.indexOf("MSAppHost") >= 0
          ? parseFloat(
              (s.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) ||
                [])[1]
            )
          : parseFloat(
    ...
    function (e, t, n) {
      ...
      t.addTouchListeners = function (e, t) {
        ...
        function x() {
          ...
          var e =
            d >= 2 ? t.selection.getLineRange(p.row) : t.session.getBracketRange(p);
                ...
                if (n === "remove") {
                  ...
                  if (l) {
                    ...
                    v == 0
                      ...
                      : v == -1 &&
                        (l.addRemoveChars(s, 0, i.column - r.column), l.shiftRow(u)),
                      (c = f.indexOf(l) + 1);
                  }
                  for (c; c < f.length; c++) {
                    var l = f[c];
            ...
            (this.toggleWord = function () {
              ...
              for (var h = 0; h < l.length; h++) {
                ...
                for (var d = 0; d <= 1; d++) {
                  var v = +!d,
                    m = n.match(
                      new RegExp("^\\s?_?(" + s.escapeRegExp(p[d]) + ")\\s?$", "i")
                    );
                  if (m) {
                    var g = n.match(
                      new RegExp(
