ace.define(
    ...
    r.importCssString(i),
      (n.exports.overlayPage = function (t, n, r) {
        ...
        function a(e) {
          (s = e),
            e &&
              ((i.style.pointerEvents = "none"), (n.style.pointerEvents = "auto"));
        }
  ...
  ace.define("ace/ext/themelist", ["require", "exports", "module"], function (
    e,
    t,
    n
  ) {
          ...
          (this.renderOptionGroup = function (e) {
            return Object.keys(e)
              .map(function (t, n) {
                var r = e[t];
                return (
                  r.position || (r.position = n / 1e4), r.label || (r.label = t), r
                );
              })
              .sort(function (e, t) {
