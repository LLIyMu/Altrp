ace.define(
          ...
          start: [
            {
              ...
              onMatch: function (e, t, n, r) {
                var i = /^\s*/.exec(r)[0],
                  ...
                  o = s[2];
                return (
                  /^(javascript|ruby|coffee|markdown|css|scss|sass|less)$/.test(o) ||
                    (o = ""),
            ...
            { token: "constant.begin.javascript.filter.slim", regex: "^(\\s*)():$" },
            { token: "constant.begin..filter.slim", regex: "^(\\s*)(ruby):$" },
            {
              token: "constant.begin.coffeescript.filter.slim",
              regex: "^(\\s*)():$",
            },
            { token: "constant.begin..filter.slim", regex: "^(\\s*)(markdown):$" },
  ...
  ace.define("ace/mode/css_completions", ["require", "exports", "module"], function (
    e,
    t,
    n
  ) {
      ...
      r.inherits(f, i),
        function () {
          ...
          (this.checkOutdent = function (t, n, r) {
            ...
            while (
              s &&
              (s.type == "comment" || (s.type == "text" && s.value.match(/^\s+$/)))
            );
          ...
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (u == -1) {
                if (i == a && r[i] == "#" && s[i] == "#")
                  return (
                    (e.foldWidgets[n - 1] = ""), (e.foldWidgets[n + 1] = ""), "start"
                  );
              } else if (
                u == i &&
                r[i] == "#" &&
                ...
                return (
                  (e.foldWidgets[n - 1] = "start"), (e.foldWidgets[n + 1] = ""), ""
                );
              return (
                u != -1 && u < i
      ...
      r.inherits(l, i),
        function () {
          (this.lineCommentStart = "#"),
            ...
            (this.checkOutdent = function (e, t, n) {
              return (
                /^\s+(end|else)$/.test(t + n) || this.$outdent.checkOutdent(t, n)
              );
            }),
            (this.autoOutdent = function (e, t, n) {
              var r = t.getLine(n);
