      ...
      s = function () {
        (this.$rules = {
          start: [
            ...
            { token: "string.regexp", regex: "(/)(?=.*/)", next: "pattern-state" },
            {
            ...
            { token: "keyword.control", regex: /\b(?:when|timeout|schedule)\b/ },
            {
              token: [
                "keyword.other",
                "meta.struct.record",
            ...
            { token: "storage.type", regex: /\b(?:enum|record|set|table|vector)\b/ },
            {
              token: [
                "storage.type",
                "text",
