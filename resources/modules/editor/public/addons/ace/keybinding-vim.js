ace.define(
  ...
  function (e, t, n) {
      ...
      return (
        t.onPasteFn ||
          (t.onPasteFn = function () {
            t.insertMode ||
              (e.setCursor(Tt(e.getCursor(), 0, 1)), wt.enterInsertMode(e, {}, t));
          }),
        t.onPasteFn
      );
    }
    ...
    function Tt(e, t, n) {
      return (
        typeof t == "object" && ((n = t.ch), (t = t.line)), S(e.line + t, e.ch + n)
      );
    }
    function Nt(e, t, n, r) {
      var i,
        ...
        i = function () {
          ...
          if (i) {
            ...
            (r = { line: r.line + d, ch: d ? r.ch : v + r.ch }),
              n.visualLine && ((t = S(t.line, 0)), (r = S(r.line, Ht(e, r.line)))),
              e.setSelection(t, r);
          }
          return [t, r];
        };
    ...
    function on(e, t, n, r, i, s) {
      ...
      for (var f = 0; f < n; f++) {
        ...
        if (!l) {
          ...
          u.push(
            r ? { line: e.lastLine(), from: c, to: c } : { line: 0, from: 0, to: 0 }
          );
          break;
        }
      ...
      function () {
        ...
        (this.setOption = function (e, n) {
          ...
          (this.scanForBracket = function (e, t, n, r) {
            ...
            if (t == 1)
              var o = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e), s);
            else
          ...
          function l(t, n, i) {
            ...
            s == "Up" || s == "Down"
              ? ((o = s == "Up" ? !0 : !1),
                ...
                a &&
                  t.target &&
                  (t.target.selectionEnd = t.target.selectionStart = Math.min(
                    a,
          ...
          switch (n.searchArgs.querySrc) {
            case "prompt":
              ...
              if (h.isPlaying) {
                ...
                Mn(e, { onClose: f, prefix: s, desc: On, onKeyUp: l, onKeyDown: c });
              break;
      ...
      vt = {
        ...
        moveToEol: function (e, t, n, r, i) {
          ...
          return (
            u.ch--,
            i ||
              ((r.lastHPos = Infinity), (r.lastHSPos = e.charCoords(u, "div").left)),
            o
          );
        },
        ...
        substitute: function (e, t) {
          ...
          if (r.length)
            (i = r[0]),
              ...
              s !== undefined &&
                (Z("pcre") ? (s = Cn(s.replace(/([^\\])&/g, "$1$$&"))) : (s = Tn(s)),
