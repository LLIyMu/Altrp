      ...
      (function () {
              ...
              n = {
                ...
                _charset: function (e) {
                  ...
                  t.match(Tokens.CHARSET_SYM) &&
                    ...
                    e !== !1 &&
                      this.fire({ type: "charset", charset: n, line: i, col: s }));
                },
                _import: function (e) {
                  var t = this._tokenStream,
                    n,
        ...
        (Pseudos.ELEMENT = 1),
          ...
          (Pseudos.isElement = function (e) {
            return (
              e.indexOf("::") === 0 || Pseudos[e.toLowerCase()] == Pseudos.ELEMENT
            );
          }),
                ...
                for (a in r)
                  r.hasOwnProperty(a) &&
                    ...
                    CSSLint.Util.indexOf(f, u.text) > -1 &&
                      (e[a] ||
                        (e[a] = { full: f.slice(0), actual: [], actualNodes: [] }),
