        ...
        var e = this.createKeywordMapper(
          {
            ...
            "storage.type.asp":
              "Dim|Call|Const|Redim|Set|Let|Get|New|Randomize|Option|Explicit",
          ...
          (this.indentKeywords = {
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              var r = e.getLine(n),
                i = /(\w+)\b/i.exec(r),
                s = i && i[1].toLowerCase();
              if (s && this.indentKeywords.hasOwnProperty(s))
                return this.vbsBlock(e, n, i.index + 1);
            }),
            (this.getFoldWidget = function (e, t, n) {
              var r = e.getLine(n),
                i = /^\s*(\w+)\b/i.exec(r),
                s = i && i[1].toLowerCase();
              return s && this.indentKeywords.hasOwnProperty(s)
                ? this.indentKeywords[s] == -1
                  ? ""
                  : s == "if" && !/then\s*$/i.test(r)
                  ? ""
                  : "start"
                : "";
            }),
              ...
              switch (l) {
                ...
                case "with":
                  ...
                  var g = new RegExp("^\\s*" + d + l, "i"),
                    y = /^\s*End\s(If|Sub|Select|Function|Class|With|Property)\s*/i.test(
                      v
                    );
        ...
        function () {
          function t(e, t, n) {
            ...
            for (var s = 0; s < e.length; s++) {
              var o = e[s];
              if (
                o.type == "keyword.control.asp" ||
                o.type == "storage.type.function.asp"
              ) {
