ace.define(
  ...
  function (e, t, n) {
    ...
    var r = e("../lib/oop"),
      ...
      s = function () {
        (this.$rules = {
          ...
          timing: [
            { token: "string.quoted.operator.timing.alda", regex: /\d+(?:s|ms)?/ },
          ...
          start: [
            ...
            { token: "entity.name.function.pipe.measure.alda", regex: /\|/ },
            {
              ...
              regex: /\(comment\b/,
              push: [
                { token: "comment.block.inline.alda", regex: /\)/, next: "pop" },
    ...
    (s.metaData = { scopeName: "source.alda", fileTypes: ["alda"], name: "Alda" }),
      r.inherits(s, i),
