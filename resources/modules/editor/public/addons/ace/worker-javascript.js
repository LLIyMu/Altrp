    ...
    (function () {
      r.implement(this, s),
        ...
        (this.applyDelta = function (e, t) {
          ...
          if (
            n ? e.lines.length <= 1 && !e.lines[0] : !o.comparePoints(e.start, e.end)
          )
            return;
              ...
              (function () {
                ...
                function Vt(e, t, n, r, i, s, a) {
                  ...
                  f || ((c = rt.call(e)), c == o ? (c = d) : c != d && (f = Zn(e))),
                    l ||
                      ((h = rt.call(t)), h == o ? (h = d) : h != d && (l = Zn(t)));
                  var p = c == d,
                    v = h == d,
                    m = c == h;
                ...
                function xn(e, t) {
                  return (
                    (e = +e), (t = t == null ? Nt : t), e > -1 && e % 1 == 0 && e < t
                  );
                }
                function Tn(e, t, n) {
                  if (!Jn(n)) return !1;
                ...
                (j[w] = j[E] = j[S] = j[x] = j[T] = j[N] = j[C] = j[k] = j[L] = !0),
                  (j[o] = j[u] = j[b] = j[a] = j[f] = j[l] = j[c] = j[h] = j[p] = j[
                    d
                  ] = j[v] = j[m] = j[g] = j[y] = !1);
                var F = {};
                (F[o] = F[u] = F[b] = F[a] = F[f] = F[w] = F[E] = F[S] = F[x] = F[
                  T
                ] = F[p] = F[d] = F[v] = F[g] = F[N] = F[C] = F[k] = F[L] = !0),
                ...
                var I = { function: !0, object: !0 },
                  ...
                  lt = Z.push,
                  ct =
                    Kn((Object.preventExtensions = Object.preventExtensions)) && ct,
                  ...
                  (un =
                    !st || !pt
                      ...
                      : function (e) {
                          ...
                          return (
                            t != r && ((s = new pt(i, r)), s.set(new pt(e, r))), i
                          );
                        });
                var yn = Yt("length"),
                  bn = at
            ...
            var r = e("../lodash"),
              ...
              p = (function () {
                ...
                function At() {
                  ...
                  if (n.id === "{") {
                    var s =
                      f.funct["(verb)"] === "case" && f.tokens.curr.value === ":";
                    _t(!0, !0, !1, !1, s);
                    return;
                  }
                  return (
                ...
                function Xt(e) {
                  ...
                  return (
                    ...
                    u &&
                      (f.inES6(!0) ||
                        F("W119", f.tokens.curr, "arrow function syntax (=>)", "6"),
                      e.loneArg || V("=>")),
                    _t(!1, !0, !0, u),
                    !f.option.noyield &&
                      o &&
                    ...
                    for (var d in a)
                      a.hasOwnProperty(d) &&
                        ...
                        d.id &&
                          ...
                          l &&
                            s &&
                            f.funct["(scope)"].setExported(d.token.value, d.token)));
                    f.tokens.next.id === "=" &&
                      (V("="),
                      !i &&
                        f.tokens.next.id === "undefined" &&
                ...
                ht(
                  ...
                  ut("+++", function () {
                    return (
                      F("W007"), (this.arity = "unary"), (this.right = Q(150)), this
                    );
                  }),
                  ht(
                    "+++",
                  ...
                  ut("---", function () {
                    return (
                      F("W006"), (this.arity = "unary"), (this.right = Q(150)), this
                    );
                  }),
                  ht(
                    "---",
                ...
                (rn.exps = !0),
                  ...
                  st("try", function () {
                    ...
                    return (
                      e || q("E021", f.tokens.next, "catch", f.tokens.next.value),
                      this
                    );
                  }),
                  (st("while", function () {
                ...
                var an = function () {
                  ...
                  vn = function () {
                    ...
                    return {
                      ...
                      setState: function (e) {
                        r.contains(["use", "define", "generate", "filter"], e) &&
                          (n.mode = e);
                      },
                      check: function (e) {
                        if (!n) return;
                        return n && n.mode === "use"
                          ...
                          : n && n.mode === "filter"
                          ? (s(e) && f.funct["(scope)"].block.use(e, f.tokens.curr),
                            !0)
                          : !1;
                      },
                    };
            ...
            (p.prototype = {
              ...
              scanPunctuator: function () {
                ...
                switch (e) {
                  ...
                  case "{":
                    return (
                      this.pushContext(c.Block), { type: l.Punctuator, value: e }
                    );
                  case "}":
                    return (
